...
public class VagrantUpRequestBuilder : AbstractVagrantRequestBuilder, IVagrantUpRequestBuilder
{
    ...
    {
        return new VagrantUpRequest(_nameOrId, _provision, _provisionWith.ToArray(), _destroyOnError, _parallel
                                  , _provider, _installProvider, BaseBuilder.Color, BaseBuilder.MachineReadable
