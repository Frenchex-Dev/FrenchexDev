...
{
    private readonly ISshConfigCommandCommandResponseBuilderFactory _commandResponseBuilderFactory;
    ...
    public SshConfigCommand(
        ISshConfigCommandCommandResponseBuilderFactory commandResponseBuilderFactory,
