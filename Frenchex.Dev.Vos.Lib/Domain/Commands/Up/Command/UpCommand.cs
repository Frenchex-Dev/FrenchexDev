...
{
    private readonly IUpCommandCommandResponseBuilderFactory _commandResponseBuilderFactory;
    ...
    public UpCommand(
        IUpCommandCommandResponseBuilderFactory commandResponseBuilderFactory,
